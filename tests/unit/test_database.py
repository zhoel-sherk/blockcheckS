...
@pytest.mark.asyncio
async def test_unique_name_proto(temp_db: StateDB):
...
@pytest.mark.asyncio
async def test_same_name_proto_idempotent(temp_db: StateDB):
...
@pytest.mark.asyncio
async def test_log_tcp_working(temp_db: StateDB):
