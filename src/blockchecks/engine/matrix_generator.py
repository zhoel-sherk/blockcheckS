...
class MatrixGenerator:
    ...
    REGISTRY = {
        ...
        "fake": lambda: StandardGenerator(strategy_types=["fake"]),
        "faked": lambda: StandardGenerator(strategy_types=["fakedsplit", "fakeddisorder"]),
        "hostfake": lambda: StandardGenerator(strategy_types=["hostfake"]),
        "fake_multi": lambda: StandardGenerator(strategy_types=["multi_fake"]),
        "fake_faked": lambda: StandardGenerator(strategy_types=["fake_fakedsplit"]),
    }
