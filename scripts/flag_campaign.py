...
def run_test(
    ...
    *,
    ...
    save_results(rows)
    print(
        f"→ {tid} exit={exit_code} {status} {wall}s rem={remaining():.0f}s {row['notes'][:100]}",
        flush=True,
    )
    return row
...
def write_report(rows: list[dict]) -> None:
    ...
    lines += [
        "",
        "## Results",
        "| ID | phase | status | wall_s | flag | notes |",
        "|----|-------|--------|--------|------|-------|",
    ]
    for r in rows:
...
def main() -> int:
    ...
    for tid, preset, proto in [
        ...
        if proto == "http":
            ...
            cmd = sudo_bs(
                ...
                "example.com",
                "-f",
                f"presets/strategies/{preset}.http",
                "--protocol",
                "http",
                "--timeout",
                "5",
    ...
    run_test(
        ...
        sudo_bs(
            ...
            "google.com",
            "-f",
            "presets/strategies/bc2-parity-quic.quic",
            "--protocol",
            "quic",
            "--timeout",
            "8",
    ...
    run_test(
        ...
        sudo_bs(
            "udp",
            "-c",
            "configs/udp_voice__fake_r6_ttl5.conf",
            "--discover-dns",
            "3",
            "--timeout",
            "4",
    ...
    run_test(
        ...
        sudo_bs(
            "udp",
            "-c",
            "configs/udp_voice__fake_r6_autottl.conf",
            "--discover-dns",
            "3",
            "--timeout",
            "4",
    ...
    run_test(
        ...
        sudo_bs(
            "udp",
            "-c",
            "configs/udp_voice__wide_ports_r6.conf",
            "--discover-dns",
            "3",
            "--timeout",
            "4",
    ...
    run_test(
        ...
        sudo_bs(
            ...
            "example.com",
            "-f",
            "presets/strategies/gp-custom-http.txt",
            "--protocol",
            "http",
            "--timeout",
            "5",
    ...
    run_test(
        ...
        sudo_bs(
            ...
            "google.com",
            "-f",
            "presets/strategies/gp-custom-quic.txt",
            "--protocol",
            "quic",
            "--timeout",
            "8",
